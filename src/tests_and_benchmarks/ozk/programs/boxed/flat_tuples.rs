...
fn main() {
    ...
    let a_0: u128 = tasm::tasmlib_io_read_stdin___u128();
    let a_1: u64 = tasm::tasmlib_io_read_stdin___u64();
    let a_2: Digest = tasm::tasmlib_io_read_stdin___digest();
    ...
    // Construct b values
    let b_0: Digest = tasm::tasmlib_io_read_stdin___digest();
    let b_1: Digest = tasm::tasmlib_io_read_stdin___digest();
    let b_2: Digest = tasm::tasmlib_io_read_stdin___digest();
    ...
    // Construct c values
    let c_0: u32 = tasm::tasmlib_io_read_stdin___bfe().value() as u32;
    let c_1: u32 = tasm::tasmlib_io_read_stdin___bfe().value() as u32;
