...
fn main() {
    let a: u128 = tasm::tasmlib_io_read_stdin___u128();
    let b: u128 = tasm::tasmlib_io_read_stdin___u128();
    let a_copied: u128 = a;
    ...
    tasm::tasmlib_io_write_to_stdout___u128(a_again);
    assert!(b == b_again);

    tasm::tasmlib_io_write_to_stdout___u128(b);
    tasm::tasmlib_io_write_to_stdout___u128(b_again);
